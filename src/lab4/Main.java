...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("lab4.Box 1: " + or.getWeight());
        System.out.println("lab4.Box 2: " + or1.getWeight());
        System.out.println("lab4.Box 3: " + ap.getWeight());
        System.out.println("lab4.Box 4: " + ap1.getWeight());
        or.pourTo(or1);
        ap.pourTo(ap1);
